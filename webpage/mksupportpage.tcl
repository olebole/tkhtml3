...
<p>
	...
	This document currently tracks the CVS version.
</p>
}
...
SUPPORTTABLE {Color and Background Properties} \
	...
	[CSSREF background-attachment nosupport] {
		There is no way to position a
		background relative to the viewport at the moment, all
		background images are relative to the containing block. This
		will wait until there's time to look at the CSS2 'position'
		property.
	} \
...
SUPPORTTABLE {Text Properties} \
	...
	[CSSREF vertical-align] {Requires investigation} \
