namespace eval hv3 { set {version($Id: hv3_dom_events.tcl,v 1.17 2007/06/02 11:21:16 danielk1977 Exp $)} 1 }
...
# Events generated by the forms module:
...
# <TEXT> elements). This is done by the forms module.
#
lappend ::hv3::dom::HTML_Events_List    keypress keydown keyup

# Events generated by hv3.tcl (based on Tk widget binding events):
#
...
# Events generated by hv3.tcl (based on protocol events):
