namespace eval hv3 { set {version($Id: hv3_home.tcl,v 1.22 2007/08/04 17:15:25 danielk1977 Exp $)} 1 }
...
proc ::hv3::create_domref {} {
  ...
  append doctop {
    ...
    <P>
      This document is the canonical reference to Hv3's version of the 
      Document Object Model (DOM). It is generated by the DOM implementation
      itself and augmented by comments in the DOM source code. It is always
      available from within Hv3 itself by selecting the 
      "Debug->DOM Reference..." menu option.
